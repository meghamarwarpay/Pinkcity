    ...
    <div className="bg-gray-50 py-8 px-6 sm:px-10 md:px-20">
      ...
      <section className="mb-12">
        ...
        <p className="text-lg text-gray-700 leading-relaxed">
          At PinkCity Infotech Solution Pvt Ltd., we are committed to providing a smooth and satisfactory shopping experience. This Refund Policy outlines our procedures regarding refunds and returns.
        </p>
      </section>

...
export default function Header() {
  ...
  useEffect(() => {
    ...
    const fetchCategories = async () => {
      try {
        ...
        const response = await apiGet('api/product2/getproducts2');
  ...
  const handleLogout = async () => {
    try {
      await apiPost("api/auth2/logOut2");
  ...
  return (
    <div className="headerfix">
      {/* Top Bar */}
      <div className="bg-danger text-white py-2 px-4 d-flex justify-content-end align-items-center">
        {isLoggedIn ? (
          <button

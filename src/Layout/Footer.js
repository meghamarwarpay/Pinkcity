...
export default function Footer() {
  return (
    <footer className="bg-dark text-light pt-5 mt-5">
      <div className="container">
        <div className="row">   
          ...
          <div className="col-md-4">
            ...
            <Link href="mailto:Pinkcityinfotek@gmail.com" className="text-light d-block mb-2">
            Pinkcityinfotek@gmail.com
            </Link>
            <address>
            Alpine tower,101,1st floor, 9 Dukan, Kalwar road, Jaipur,Rajasthan
              
            </address>
            <Link href="tel:+919351888150" className="text-light">
              +91 9351888150
            </Link>
          </div>
      ...
      <div className="bg-danger text-light text-center py-3 mt-4">
        <p className="mb-0">Copyright &copy; {new Date().getFullYear()} PinkCIty Infotech Solution Pvt Ltd. All Rights Reserved</p>
      </div>
    </footer>
  );
}
